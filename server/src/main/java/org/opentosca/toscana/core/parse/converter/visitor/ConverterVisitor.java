...
public abstract class ConverterVisitor<NodeT extends DescribableEntity, BuilderT extends DescribableEntityBuilder> extends AbstractVisitor<ConversionResult<NodeT>, NodeContext<BuilderT>> {
